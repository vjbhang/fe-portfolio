...
export default function MouseScroll({
  ...
  function Circle({
    ...
    return (
      <div
        className={`w-3.5 h-1.5 transition delay-150 duration-300 ease-in rounded-full ${filled ? "bg-cyan-300/70" : graded && `${direction === "left" ? "bg-linear-to-l from-cyan-300/70 to-transparent" : "bg-linear-to-r from-cyan-300/70 to-transparent"}`} border border-white linear`}
      />
    );
  }
